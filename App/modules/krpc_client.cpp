...
const TaskParameters_t KrpcClient::krpc_clientTaskDefinition =
{
	...
	krpc_client_taskStack,
	{
		...
		{ _tinyusb_bss_run_addr, __tinyusb_data_region_size__, portMPU_REGION_READ_WRITE | portMPU_REGION_EXECUTE_NEVER | CACHE_CONF(configTEX_S_C_B_TCMRAM) },
		{ _krpc_bss_run_addr, __krpc_data_region_size__, portMPU_REGION_READ_WRITE | portMPU_REGION_EXECUTE_NEVER | CACHE_CONF(configTEX_S_C_B_TCMRAM) },
