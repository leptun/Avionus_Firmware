...
extern HAL_StatusTypeDef HAL_SD_Uninterrupted_Sync(SD_HandleTypeDef *hsd);
extern uint8_t HAL_SD_EXT_IRQHandler(SD_HandleTypeDef *hsd);

extern HAL_StatusTypeDef HAL_SD_Discard(SD_HandleTypeDef *hsd, uint32_t BlockStartAdd, uint32_t BlockEndAdd);
