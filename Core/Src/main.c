...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : UI_LED_GPS_Pin UI_LED_STATUS_Pin POWER_D5_EN_Pin */
  ...
  /*Configure GPIO pins : SD_CARD_CD_Pin SD_CARD_WP_Pin */
  GPIO_InitStruct.Pin = SD_CARD_CD_Pin|SD_CARD_WP_Pin;
